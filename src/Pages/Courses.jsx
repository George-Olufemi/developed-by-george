          ...
          <div className='md:grid md:gap-10 md:grid-cols-3  px-10 md:px-16 pt-10'>
              <Link to="/htmlcoursevideos">
                <div className='bg-gray-200 rounded-t-3xl rounded-b-3xl mb-10 hover:shadow-2xl hover:scale-105 transition-all duration-300 pr-0'>
                  <img className="rounded-t-3xl object-contain" src={htm} alt='' />
              ...
              <Link to="/csscoursevideos">
                <div className='bg-gray-200 rounded-t-3xl rounded-b-3xl mb-10 hover:shadow-2xl hover:scale-105 transition-all duration-300 pr-0'>
                  <img className="rounded-t-3xl object-contain" src={css} alt='' />
              ...
              <Link to="/bootstrapcoursevideos">
                <div className='bg-gray-200 rounded-t-3xl rounded-b-3xl mb-10 hover:shadow-2xl hover:scale-105 transition-all duration-300 pr-0'>
                  <img className="rounded-t-3xl h-full w-full object-cover" src={bootstrap} alt='' />
              ...
              <Link to="/javascriptcoursevideos">
                <div className='bg-gray-200 rounded-t-3xl rounded-b-3xl mb-10 hover:shadow-2xl hover:scale-105 transition-all duration-300 pr-0'>
                <img className="rounded-t-3xl object-contain" src={javascript} alt='' />
              ...
              <Link to="/gitandgithubcoursevideos">
                <div className='bg-gray-200 rounded-t-3xl rounded-b-3xl mb-10 hover:shadow-2xl hover:scale-105 transition-all duration-300 pr-0'>
                <img className="rounded-t-3xl object-cover h-full w-full" src={git} alt='' />
              ...
              <Link to="/reactcoursevideos">
                <div className='bg-gray-200 rounded-t-3xl rounded-b-3xl mb-10 hover:shadow-2xl hover:scale-105 transition-all duration-300 pr-0'>
                <img className="rounded-t-3xl object-cover" src={reactjs} alt='' />
